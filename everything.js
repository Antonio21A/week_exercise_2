...
console.log(sum("5")); // Output: 0
console.log(sum(3.2)); // Output: "The value passed is not a number"
...
console.log(funkyMath(2, 8)); // Output: 6
...
console.log("Even Numbers:", numbers); // Output: Even Numbers: [ 2, 6, 44 ]
console.log("Odd Numbers:", oddNumbers); // Output: Odd Numbers: [ 1, 33, 45 ]
...
const me = {
    ...
    lastName: "Stark",
    age: 21,
    favouriteColour: "Frsot white",
    dreamCar: "Nissan GT-R"
};
